...
using Martivi.Models.AboutUs;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace Martivi.ViewModels.AboutUs
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:Martivi.ViewModels.AboutUs.AboutUsViewModel"/> class.
        /// </summary>
